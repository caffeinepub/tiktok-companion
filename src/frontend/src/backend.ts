...
function from_candid_PublicationState_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PublicationState): PublicationState {
...
function from_candid_VideoIdea_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoIdea): VideoIdea {
...
function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_VideoIdea>): Array<VideoIdea> {
    return value.map((x)=>from_candid_VideoIdea_n12(_uploadFile, _downloadFile, x));
}
